    ...
    <%@ page import="java.util.List,com.oceanview.model.RoomType" %>
        <% com.oceanview.model.Reservation r=(com.oceanview.model.Reservation) request.getAttribute("reservation");
            ...
            <head>
                ...
                <link rel="stylesheet" href="<%=request.getContextPath()%>/assets/css/modify-reservation.css">
